...
<div class="topnav">
  ...
  <div id="myLinks" style="background-color: #555;">
    ...
    <a href="antes_depois.php">ANTES E DEPOIS</a>
...
<div class="menu-box">
  <div class="dropdown">
    ...
    <div class="dropdown-content">
      <a href="harmonizacao.php#skinbooster" class="link_menu">Skinbooster</a>
      <a href="harmonizacao.php#peeling" class="link_menu">Peeling Químico</a>
      <a href="harmonizacao.php#colageno" class="link_menu">Bioestimuladores de Colágeno</a>
      <a href="harmonizacao.php#botox" class="link_menu">Botox</a>
      <a href="harmonizacao.php#facetas" class="link_menu">Lentes em resina e porcelana (facetas)</a>
    </div>
  </div> | 
  <div class="dropdown">
    <button class="drops" onclick="javascript:location.href='estetica_corporal.php';">Estética Corporal</button> <i class="fa fa-caret-down"></i>
    <div class="dropdown-content">
      <a href="estetica_corporal.php#drenagem" class="link_menu">Drenagem Linfática Manual</a>
      <a href="estetica_corporal.php#massagem" class="link_menu">Massagem Relaxante</a>
      <a href="estetica_corporal.php#modeladora" class="link_menu">Modeladora (Redutora)</a>
      <a href="estetica_corporal.php#limpeza" class="link_menu">Limpeza de Pele</a>
    </div>
  </div> | 
  <div class="dropdown">
    <button class="drops" onclick="javascript:location.href='odontologia.php';">Odontologia</button> <i class="fa fa-caret-down"></i>
    <div class="dropdown-content">
      <a href="odontologia.php#implantodontia" class="link_menu">Implantodontia</a>
      <a href="odontologia.php#ortodontia" class="link_menu">Ortodontia</a>
      <a href="odontologia.php#periodontia" class="link_menu">Periodontia</a>
      <a href="odontologia.php#odontopediatria" class="link_menu">Odontopediatria</a>
      <a href="odontologia.php#protese" class="link_menu">Prótese</a>
      <a href="odontologia.php#cirurgia" class="link_menu">Cirurgia</a>
